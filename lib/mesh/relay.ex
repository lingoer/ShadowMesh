defmodule ShadowMesh.Relay do
  ...
  defp send_payload(socket, conv, sn, payload) do
    ...
    :ok = :gen_tcp.send(socket, <<2, conv::binary-16, sn::16, len::16>>)
  ...
  def handle_call({:send, conv, sn, payload}, _, {socket, _group_id}) do
  ...
  def handle_call({:connect, conv, _sn, _payload}, _, {socket, _group_id}) do
